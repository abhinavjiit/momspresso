...
import org.wordpress.aztec.util.*
...
open class AztecText : AppCompatEditText, TextWatcher, UnknownHtmlSpan.OnUnknownHtmlTappedListener, IEventInjector {
    companion object {
        ...
        var watchersNestingLevel: Int = 0
         ...
         fun getPlaceholderDrawableFromResID(context: Context, @DrawableRes drawableId: Int, maxImageWidthForVisualEditor: Int): BitmapDrawable {
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        setBackgroundColor(styles.getColor(R.styleable.AztecText_backgroundColor, ContextCompat.getColor(context, R.color.grey)))
    ...
    private fun install() {
        ...
        InlineTextWatcher.install(inlineFormatter, this,context)
    ...
    open fun fromHtml(source: String, isInit: Boolean = true) {
        ...
        builder.append(parser.fromHtml(cleanSource, context, true))
//        builder.append(cleanSource)
