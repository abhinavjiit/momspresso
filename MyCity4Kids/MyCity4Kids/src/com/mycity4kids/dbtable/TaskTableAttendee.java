 ...
 */
public class TaskTableAttendee extends BaseTable {
    ...
    public static final String TASK_ATTTENDEE_TABLE = "taskAttendeeTable";

    public static final String CREATE_TASK_ATTTENDEE_TABLE = "create table if not exists " +
            TASK_ATTTENDEE_TABLE + "(" + PRIMARY_KEY + " integer primary key," +
            EVENT_ID + " integer not null ," +
            SERVER_ID + " integer not null ," +
            USERKID_ID + " integer not null ," +
            TYPE + " text not null )";

    public static final String DROP_QUERY = "Drop table if exists " + TASK_ATTTENDEE_TABLE;

    public TaskTableAttendee(BaseApplication pApplication) {
        super(pApplication, TASK_ATTTENDEE_TABLE);
        // TODO Auto-generated constructor stub
    }

    @Override
    protected ContentValues getContentValues(BaseModel pModel) {
        TaskDataModel.Attendee attendeemodel = (TaskDataModel.Attendee) pModel;
    ...
    public void AddAttendeeList(BaseModel pModel) {
        ...
        try {
            ...
            mWritableDatabase.insert(TASK_ATTTENDEE_TABLE, null, _contentValue);
    ...
    public void deleteTask(int pId) {
        ...
        try {
            ...
            int i = mWritableDatabase.delete(TASK_ATTTENDEE_TABLE, EVENT_ID + " = " + pId, null);
    ...
    public ArrayList<AttendeeModel> getDataBytask(int id) {
        ...
        Cursor _cursor = null;
        try {
            String CREATE_QUERY = "select userkid_id ,server_id, type,kt.colorCode as kidcolor,kt.name as kidname,ad.colorCode as usercolorcode,ad.name as username from taskAttendeeTable at LEFT JOIN kidsTable kt  ON at.userkid_id == kt.kid_id LEFT JOIN adultTable ad ON at.userkid_id == ad.USERID where event_id = " + id;
