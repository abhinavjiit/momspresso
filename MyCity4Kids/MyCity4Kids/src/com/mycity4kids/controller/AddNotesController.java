...
public class AddNotesController extends BaseController {
    ...
    public ServiceRequest getData(int requestType, Object requestData) {
        ...
        serviceRequest.setUrl(AppConstants.ADD_NOTES_URL);
        ...
        switch (response.getDataType()) {
            case AppConstants.ADD_NOTES_REQ:
                try {
                   ...
                   AddNotesResponse _signUpData = new Gson().fromJson(responseData, AddNotesResponse.class);
    ...
    private HttpEntity setRequestParameters(Object requestData) {
        ...
        try {
            ...
            nameValuePairs.add(new BasicNameValuePair("appointment_id", "" + _requestModel.getAppointmentid()));
