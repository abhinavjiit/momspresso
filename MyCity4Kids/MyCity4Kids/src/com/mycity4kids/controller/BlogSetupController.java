 ...
 */
public class BlogSetupController extends BaseController{


    private static final String LOG_TAG = "BlogSetupController";
    private Activity context;

    public BlogSetupController(Activity activity, IScreen screen) {
    ...
    public ServiceRequest getData(int requestType, Object requestData) {
        ...
        switch (requestType) {
            case AppConstants.BLOG_SETUP_REQUEST: {
                ...
                serviceRequest.setUrl(AppConstants.BLOG_SETUP_URL);
                break;
            }
    ...
    private List<NameValuePair> setRequestParameters(Object pRequestModel) {
        ...
        try {
         ...
         /*   nameValuePairs.add(new BasicNameValuePair("id", articleDraftRequest.getId()));
            ...
            Log.i("BlogSetupRequest", nameValuePairs.toString());
        ...
        sendResponseToScreen(null);
            ...
            case AppConstants.BLOG_SETUP_REQUEST:
                ...
                if (response != null) {
                    CommonResponse _forgotResponse1;
                    String responseDatta = new String(response.getResponseData());
                    System.out.println("blog setup response " + responseDatta);
