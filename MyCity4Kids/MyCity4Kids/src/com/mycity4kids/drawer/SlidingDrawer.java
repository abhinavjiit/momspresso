package com.mycity4kids.drawer;
...
public class SlidingDrawer extends FrameLayout {
    ...
    private static final float TOUCH_TARGET_WIDTH_DIP = 60.0f;
  ...
  //  private LinearLayout mLinearLayout;
	...
	/*public void setHomeLinearLayout(LinearLayout pLinearLayout){
    ...
    public SlidingDrawer(Activity activity, View drawerLayout) {
        super(activity);
        ...
        mDrawerContent = (ViewGroup) drawerLayout;
    ...
    public SlidingDrawer(Activity activity, int drawerLayout) {
        super(activity);
    ...
    /** 
     * If we want to open drawer on touch event also:-
     */
    ...
    public void openDrawer(final boolean animate) {
    	...
    	/*if(mLinearLayout!=null){
    		mLinearLayout.setBackgroundColor(getContext().getResources().getColor(R.color.transparent_color));
    	}*/
        if(mDrawerMoving){
