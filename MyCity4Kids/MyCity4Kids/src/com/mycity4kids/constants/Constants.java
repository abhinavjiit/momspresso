...
//	public static int BACK_PRESS_CONST = 0 ;
    ...
    public enum TypeOfLanguages {
        ...
        LOCALE_KANNADA("kn", "Kannada"), LOCALE_MALAYALAM("ml", "Malayalam"), LOCALE_GUJARATI("gu", "Gujarati"), LOCALE_PUNJABI("pa", "Punjabi");
        private final String name;
    ...
    public enum TypeOfLanguagesWithContent {
        ...
        LOCALE_KANNADA("kn", "ಕನ್ನಡ"), LOCALE_MALAYALAM("ml", "മലയാളം"), LOCALE_GUJARATI("gu", "ગુજરાતી"), LOCALE_PUNJABI("pa", "ਪੰਜਾਬੀ");
        private final String name;
        private final String id;
    ...
    public enum TrackerStatusMapping {
        APPROVED(2, "APPROVED"), APPLIED(3, "APPLIED"), PROOF_APPPROVAL(7, "PROOFS APPROVED"), PROOF_SUBMITTED_REJECTED(10, "PROOFS SUBMITTED REJECTED"),
        APPLICATION_UNDER_REVIEW(11, "APPLICATION UNDER REVIEW"), PROOF_UNDER_REVIEW(12, "PROOFS UNDER REVIEW"),
        PAYMENT_IN_PROCESS(13, "PAYMENT IN PROCESS"), PAYMENT_DONE(14, "PAYMENT DONE"), PROOF_SUBMITTED(15, "PROOFS SUBMITTED");
        private final String name;
        private final int id;
