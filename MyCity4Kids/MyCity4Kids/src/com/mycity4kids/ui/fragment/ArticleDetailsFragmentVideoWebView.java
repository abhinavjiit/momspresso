...
import com.mycity4kids.VideoEnabledWebChromeClient;
import com.mycity4kids.VideoEnabledWebView;
 ...
 */
public class ArticleDetailsFragmentVideoWebView extends BaseFragment implements View.OnClickListener, ObservableScrollViewCallbacks {
...
//    ImageView commentBtn;
    ...
    FloatingActionButton recommendFloatingActionButton;
    ...
    private VideoEnabledWebChromeClient topWebChromeClient;
...
//    private boolean hasRecommendSuggestionAppeared = true;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        fragmentView = inflater.inflate(R.layout.article_details_fragment_vide, container, false);
...
//            ((TextView) fragmentView.findViewById(R.id.add_comment)).setOnClickListener(this);
            ...
            recommendFloatingActionButton = (FloatingActionButton) fragmentView.findViewById(R.id.recommendFloatingActionButton);
            recommendFloatingActionButton.setOnClickListener(this);
            recommendFloatingActionButton.setEnabled(false);

            ViewGroup videoLayout = (ViewGroup) getActivity().findViewById(R.id.articleWebViewContainer);
            mWebView = (VideoEnabledWebView) fragmentView.findViewById(R.id.articleWebView);
            videoWebView = (VideoEnabledWebView) fragmentView.findViewById(R.id.videoWebView);
...
//            View videoMainLayout = fragmentView.findViewById(R.id.videoMainLayout);
            webChromeClient = new VideoEnabledWebChromeClient(coordinatorLayout, videoLayout, null, mWebView);
            topWebChromeClient = new VideoEnabledWebChromeClient(coordinatorLayout, videoLayout, null, videoWebView);

            webChromeClient.setOnToggledFullscreen(toggledFullscreenCallback);
            topWebChromeClient.setOnToggledFullscreen(toggledFullscreenCallback);

            mWebView.setWebChromeClient(webChromeClient);
            mWebView.setWebViewClient(new InsideWebViewClient());
            videoWebView.setWebChromeClient(topWebChromeClient);
            videoWebView.setWebViewClient(new InsideWebViewClient());
...
//                        String vUrl = "<html><head></head><body><p style='text-align:center'><a href=http:" + video.getVideoUrl() +
//                                "</a></p></body></html>";
...
//                    } else if (bodyDescription.contains(video.getKey())) {
                        ...
                        bodyDesc = bodyDesc.replace(video.getKey(), "<p style='text-align:center'><a href=http:" + vURL + "</a></p>");
//                    }
                }
            }
...
//                        recommendFloatingActionButton.setIconDrawable(ContextCompat.getDrawable(getActivity(), R.drawable.heart_filled));
                        ...
                        likeArticleTextView.setCompoundDrawablesWithIntrinsicBounds(null, top, null, null);
//                        recommendFloatingActionButton.setIconDrawable(ContextCompat.getDrawable(getActivity(), R.drawable.heart_outline));
                ...
                case R.id.emailShareTextView:
                    ...
                    intent.putExtra(Intent.EXTRA_SUBJECT, "mycity4kids");
                    intent.putExtra(Intent.EXTRA_TEXT, AppUtils.fromHtml("mycity4kids\n\nCheck out this interesting blog post\n " + shareUrl));
...
//                hideToolbar();
//            }
//            if (!isArticleDetailEndReached && recommendFloatingActionButton.getVisibility() == View.VISIBLE) {
