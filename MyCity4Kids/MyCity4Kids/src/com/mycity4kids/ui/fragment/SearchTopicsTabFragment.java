 ...
 */
public class SearchTopicsTabFragment extends BaseFragment {

    SearchTopicsListingAdapter articlesListingAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        articlesListingAdapter = new SearchTopicsListingAdapter(getActivity());
        listView.setAdapter(articlesListingAdapter);
        if (getArguments() != null) {
            searchName = getArguments().getString(Constants.SEARCH_PARAM);
        }
        articleDataModelsNew = new ArrayList<SearchTopicResult>();
    ...
    private void getArticleResponse(SearchResponse responseData) {
        ...
        if (dataList.size() == 0) {
            ...
            if (null != articleDataModelsNew && !articleDataModelsNew.isEmpty()) {
                ...
                noBlogsTextView.setText("No topics found");
            }
