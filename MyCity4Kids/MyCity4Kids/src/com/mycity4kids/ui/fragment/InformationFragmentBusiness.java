...
public class InformationFragmentBusiness extends BaseFragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_info_business, null, false);
		...
		if( facilitiesModel == null ) {
            ...
            if (StringUtils.isNullOrEmpty(mBusinessInfoModel.getOrganised_by())) {
                ...
                view.findViewById(R.id.separator_org).setVisibility(View.VISIBLE);
            ...
            if (StringUtils.isNullOrEmpty(mBusinessInfoModel.getActivities())) {
                ...
                view.findViewById(R.id.separator_act).setVisibility(View.VISIBLE);
            ...
            if ((batchedList != null && batchedList.size() > 0 && mEventOrBusiness == Constants.EVENT_PAGE_TYPE) || mEventOrBusiness == Constants.BUSINESS_PAGE_TYPE) {
                ...
                if (StringUtils.isNullOrEmpty(mBusinessInfoModel.getAge_group())) {
                    ...
                    view.findViewById(R.id.separator_age).setVisibility(View.VISIBLE);
                }
            } else {
                view.findViewById(R.id.age_group_txt).setVisibility(View.GONE);
            ...
            if (StringUtils.isNullOrEmpty(eventDatesStr)) {
                ...
                view.findViewById(R.id.event_dates_txt).setVisibility(View.GONE);
                txvEventDatesDesc.setVisibility(View.GONE);
                txvEventDatesDesc.setText(eventDatesStr);
                view.findViewById(R.id.separator_age).setVisibility(View.VISIBLE);
            }
            ...
            if (StringUtils.isNullOrEmpty(timingsStr)) {
                ...
                txvTimingsDesc.setText(timingsStr);
                view.findViewById(R.id.separator_timing).setVisibility(View.VISIBLE);
            }
            ...
            if (StringUtils.isNullOrEmpty(mBusinessInfoModel.getCost())) {
                ...
                cost.setText(mBusinessInfoModel.getCost());
                view.findViewById(R.id.separator_cost).setVisibility(View.VISIBLE);
            }
            ...
            if (StringUtils.isNullOrEmpty(mBusinessInfoModel.getDescription())) {
                ...
                view.findViewById(R.id.separator_description).setVisibility(View.VISIBLE);
            }
            ...
            if (StringUtils.isNullOrEmpty(mBusinessInfoModel.getAbout())) {
                ...
                view.findViewById(R.id.separator_about).setVisibility(View.VISIBLE);
            }
            ...
            if (addInfosList == null || addInfosList.isEmpty()) {
                ...
                view.findViewById(R.id.separator_extra).setVisibility(View.VISIBLE);
    ...
    private void removeAndAddViews(View view) {
        ...
        if (batches != null) {
            ...
            if (!StringUtils.isNullOrEmpty(activity)) {
                ...
                headerTxt.setCompoundDrawablesWithIntrinsicBounds(R.drawable.rsz_activities_icon, R.drawable.separator, 0, 0);
            ...
            if (!StringUtils.isNullOrEmpty(startAgeGroup)) {
                ...
                headerTxt.setCompoundDrawablesWithIntrinsicBounds(R.drawable.rsz_age_group_icon, R.drawable.separator, 0, 0);
            ...
            if (!StringUtils.isNullOrEmpty(date)) {
                ...
                childTxt = (TextView) internalChildLayout.findViewById(R.id.common_txt_desc);
                headerTxt = (TextView) internalChildLayout.findViewById(R.id.common_txt);
                headerTxt.setText("Event Dates");
                headerTxt.setCompoundDrawablesWithIntrinsicBounds(R.drawable.rsz_event_date_icon, R.drawable.separator, 0, 0);
            ...
            if (!StringUtils.isNullOrEmpty(timings)) {
                ...
                childTxt = (TextView) internalChildLayout.findViewById(R.id.common_txt_desc);
                headerTxt = (TextView) internalChildLayout.findViewById(R.id.common_txt);
                headerTxt.setText("Timings");
                headerTxt.setCompoundDrawablesWithIntrinsicBounds(R.drawable.rsz_info_timing_icon, R.drawable.separator, 0, 0);
            ...
            if (!StringUtils.isNullOrEmpty(batches.getCost())) {
                ...
                headerTxt.setCompoundDrawablesWithIntrinsicBounds(R.drawable.rsz_info_cost, R.drawable.separator, 0, 0);
                //				viewDividerBottom=(View)internalChildLayout.findViewById(R.id.view_divider_bottom);
                //				viewDividerBottom.setVisibility(View.VISIBLE);
