...
import com.mycity4kids.ui.adapter.HomeVideosListingAdapter;
 ...
 */
public class HomeVideosTabFragment extends BaseFragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {


    private HomeVideosListingAdapter articlesListingAdapter;
    private ArrayList<HomeVideosListingResult> articleDataModelsNew;
...
//        progressBar.setVisibility(View.VISIBLE);
        ...
        articleDataModelsNew = new ArrayList<HomeVideosListingResult>();
        nextPageNumber = 1;
        hitArticleListingApi();

        articlesListingAdapter = new HomeVideosListingAdapter(getActivity());
...
//        Utils.pushOpenArticleListingEvent(this, GTMEventType.FUNNY_VIDEOS_LISTING_CLICK_EVENT, fromScreen, SharedPrefUtils.getUserDetailModel(getActivity()).getDynamoId(), "Funny Videos", "" + nextPageNumber);
        ...
        Call<HomeVideosListingResponse> callRecentVideoArticles = vlogsListingAndDetailsAPI.getHomeVideos(/*from, from + limit - 1, sortType, 3*/);
        callRecentVideoArticles.enqueue(recentArticleResponseCallback);
        // progressBar.setVisibility(View.VISIBLE);

    }

    private Callback<HomeVideosListingResponse> recentArticleResponseCallback = new Callback<HomeVideosListingResponse>() {
        @Override
        public void onResponse(Call<HomeVideosListingResponse> call, retrofit2.Response<HomeVideosListingResponse> response) {
...
//                showToast("Something went wrong from server");
            ...
            try {
                HomeVideosListingResponse responseData = response.body();
...
//                showToast(getString(R.string.went_wrong));
        ...
        @Override
        public void onFailure(Call<HomeVideosListingResponse> call, Throwable t) {
    ...
    private void processResponse(HomeVideosListingResponse responseData) {
        ArrayList<HomeVideosListingResult> dataList = responseData.getData().get(0).getResult();
