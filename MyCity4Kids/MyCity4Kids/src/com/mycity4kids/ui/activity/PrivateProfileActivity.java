...
//        FirebaseStorage storage = FirebaseStorage.getInstance("gs://api-project-3577377239.appspot.com/new-videos-upload/v1/android");
//
//        StorageReference storageRef = storage.getReference();
//
////        Uri file = Uri.fromFile(file2);
//        StorageReference riversRef = storageRef.child("images/" + file2.getLastPathSegment());
