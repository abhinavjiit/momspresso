...
public class GroupPhotosRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GroupPhotosRecyclerAdapter(Context pContext, RecyclerViewClickListener listener) {
        mContext = pContext;
