 ...
 */
public class PublishedArticleListAdapter extends BaseAdapter implements PinnedSectionListView.PinnedSectionListAdapter {
    Context context;
    ...
    public PublishedArticleListAdapter(Context context, ArrayList<PublishDraftObject> draftlist) {
