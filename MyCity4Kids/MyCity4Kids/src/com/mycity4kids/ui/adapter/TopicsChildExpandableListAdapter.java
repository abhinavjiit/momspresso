 ...
 */
public class TopicsChildExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public TopicsChildExpandableListAdapter(Context context) {
...
//                checkAllSubcategoriesAndChildSelected();
    ...
    private void updateSelectedChilds() {
