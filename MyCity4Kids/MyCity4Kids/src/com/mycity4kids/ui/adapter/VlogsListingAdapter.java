...
//            }
            holder.rankTextView.setVisibility(View.GONE);
            if (AppConstants.USER_TYPE_BLOGGER.equals(articleDataModelsNew.get(position).getAuthor().getUserType())) {
            ...
            } else if (AppConstants.USER_TYPE_EDITOR.equals(articleDataModelsNew.get(position).getAuthor().getUserType())) {
            ...
            } else if (AppConstants.USER_TYPE_EDITORIAL.equals(articleDataModelsNew.get(position).getAuthor().getUserType())) {
            ...
            } else if (AppConstants.USER_TYPE_EXPERT.equals(articleDataModelsNew.get(position).getAuthor().getUserType())) {
            ...
            } else if (AppConstants.USER_TYPE_FEATURED.equals(articleDataModelsNew.get(position).getAuthor().getUserType())) {
            ...
            } else if (AppConstants.USER_TYPE_USER.equals(articleDataModelsNew.get(position).getAuthor().getUserType())) {
                holder.authorTypeTextView.setText(AppConstants.AUTHOR_TYPE_USER.toUpperCase());
                holder.authorTypeTextView.setTextColor(ContextCompat.getColor(mContext, R.color.authortype_colorcode_blogger));
            }
            ...
            holder.txvAuthorName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (AppConstants.USER_TYPE_USER.equals(articleDataModelsNew.get(position).getAuthor().getUserType())) {
                        return;
                    }
