 ...
 */
public class SearchBlogsListingAdapter extends BaseAdapter {
    ...
    public SearchBlogsListingAdapter(Context pContext) {
    ...
    public void setListData(ArrayList<SearchBlogResult> mParentingLists) {
    ...
    public void refreshArticleList(ArrayList<SearchBlogResult> newList) {
