...
public class GroupDiscussionRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GroupDiscussionRecyclerAdapter(Context pContext, RecyclerViewClickListener listener) {
        mContext = pContext;
