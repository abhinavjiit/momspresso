 ...
 */
public class CommentsListAdapter extends BaseAdapter implements PinnedSectionListView.PinnedSectionListAdapter {
    Context context;
    ...
    public CommentsListAdapter(Context context, ArrayList<PublishDraftObject> draftlist) {
