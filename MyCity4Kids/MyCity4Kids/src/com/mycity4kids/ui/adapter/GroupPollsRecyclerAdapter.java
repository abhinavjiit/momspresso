...
public class GroupPollsRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GroupPollsRecyclerAdapter(Context pContext, RecyclerViewClickListener listener) {
        mContext = pContext;
