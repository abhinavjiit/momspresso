...
class BadgesProfileWidget : LinearLayout {
    ...
    lateinit var badgeImageView1: ImageView
    ...
    private fun initializeView() {
        ...
        getBadges(SharedPrefUtils.getUserDetailModel(context).dynamoId)
    }
