...
public class VideoAnalytics {
    ...
    public ExoPlayer.DefaultEventListener getListener(final SimpleExoPlayer player, final String url,
            final String title, final String des, final String tags) {
        return new ExoPlayer.DefaultEventListener() {
            ...
            public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
                if (playWhenReady && playbackState == ExoPlayer.STATE_READY) {
                    ...
                    switch (playbackState) {
                        ...
                        default:
                            addEvent(vaIndex, "onPlayerStateChanged", player.getCurrentPosition(),
            ...
            public void onShuffleModeEnabledChanged(boolean shuffleModeEnabled) {
                ...
                addEvent(vaIndex, "onShuffleModeEnabledChanged", player.getCurrentPosition(),
                        player.getBufferedPercentage());
            }
            ...
            public void onPositionDiscontinuity(int reason) {
                ...
                addEvent(vaIndex, "onPositionDiscontinuity", player.getCurrentPosition(),
                        player.getBufferedPercentage());
            }
            ...
            public void onPlaybackParametersChanged(PlaybackParameters playbackParameters) {
                ...
                addEvent(vaIndex, "onPlaybackParametersChanged", player.getCurrentPosition(),
                        player.getBufferedPercentage());
            }
    ...
    private int getIndex(String url, String title, String des, String tags) {
    ...
    private boolean addEvent(int index, String type, long position, int bufferedPercent) {
        try {
    ...
    private void sendPost(final String data) {
    ...
    private static String compressLZW(String data) {
