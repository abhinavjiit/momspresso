...
class CollectionItemsListAdapter(var activity: Context, var recyclerViewClick: RecyclerViewClick) :
        ...
        try {
            ...
            if (userCollectionsTopicList[position].item_info.viewCount > 0)
                holder.viewCountTextView.text =
                    userCollectionsTopicList[position].item_info.viewCount.toString()
            ...
            if (userCollectionsTopicList[position].itemType.equals(AppConstants.CONTENT_TYPE_VIDEO)) {
                ...
                holder.articleAuthorName.text =
                    userCollectionsTopicList[position].item_info.userName
            } else {
                try {
    ...
    class ViewHolder(mView: View, recyclerViewClick: RecyclerViewClick) :
