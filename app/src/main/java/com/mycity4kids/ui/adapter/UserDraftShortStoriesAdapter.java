 ...
 */
public class UserDraftShortStoriesAdapter extends RecyclerView.Adapter<UserDraftShortStoriesAdapter.UserDraftArticleViewHolder> {
    ...
    public UserDraftShortStoriesAdapter(Context pContext, SSRecyclerViewClickListener listener) {
...
//    }
    ...
    public class UserDraftArticleViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public UserDraftArticleViewHolder(View itemView, SSRecyclerViewClickListener listener) {
            super(itemView);
