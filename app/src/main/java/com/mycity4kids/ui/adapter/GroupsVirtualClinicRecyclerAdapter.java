...
public class GroupsVirtualClinicRecyclerAdapter extends
        RecyclerView.Adapter<GroupsVirtualClinicRecyclerAdapter.FeedViewHolder> {
    ...
    public GroupsVirtualClinicRecyclerAdapter(Context context, RecyclerViewClickListener listener) {
    ...
    private void addArticleItem(final GroupsVirtualClinicRecyclerAdapter.FeedViewHolder holder, final int position) {
