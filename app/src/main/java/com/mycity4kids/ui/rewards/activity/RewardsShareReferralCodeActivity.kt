...
class RewardsShareReferralCodeActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textCode.setOnClickListener {
            ...
            val myClip1 = ClipData.newPlainText("text", textCode.text.toString())
    ...
    fun openSharingDialog() {
        ...
        i.putExtra(
            ...
            "Participate in campaigns by brands you love and use. Start earning MyMoney! \n https://www.momspresso.com/usersprofile/rewardsform?referrer=${textCode.text}"
        )
    ...
    fun shareViaWhatsApp() {
        ...
        try {
            ...
            Toast.makeText(
                this@RewardsShareReferralCodeActivity,
                getString(R.string.moderation_or_share_whatsapp_not_installed),
                Toast.LENGTH_SHORT
            ).show()
    ...
    private fun fetReferralCode() {
        ...
        if (userId != null) {
            ...
            BaseApplication.getInstance().retrofit.create(RewardsAPI::class.java)
                .getReferralCode(userId!!).subscribeOn(Schedulers.io())
