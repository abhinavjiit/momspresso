...
/**
 * Interface for a model to implement in order for it to be able to be mentioned. This is specifically used by the
 * {@link MentionsEditText}. Note that all mentions, by definition, are suggestible.
 */
public interface Mentionable extends Suggestible {
    ...
    /**
     * Get the string representing what the mention should currently be displaying, depending on the given {@link
     * MentionDisplayMode}.
     *
