...
public class MentionsEditable extends SpannableStringBuilder implements Parcelable {
    ...
    /**
     * Given an integer offset, return the {@link MentionSpan} located at the offset in the text of the {@link
    ...
    public static final Creator<MentionsEditable> CREATOR = new Creator<MentionsEditable>() {
