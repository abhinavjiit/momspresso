...
package com.mycity4kids.tagging.mentions;
...
import com.mycity4kids.tagging.mentions.Mentionable.MentionDisplayMode;
import com.mycity4kids.tagging.ui.MentionsEditText;

/**
 * Class representing a spannable {@link Mentionable} in an {@link EditText}. This class is specifically used by the
 * {@link MentionsEditText}.
 */
public class MentionSpan extends ClickableSpan implements Parcelable {
    ...
    private MentionDisplayMode displayMode = MentionDisplayMode.FULL;
    ...
    public String getDisplayString() {
        return mention.getTextForDisplayMode(displayMode);
    }
    ...
    public MentionSpan(@NonNull Parcel in) {
        ...
        displayMode = MentionDisplayMode.values()[in.readInt()];
